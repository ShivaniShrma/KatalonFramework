...
CustomKeywords.'applicationKeyword.WebKeywords.ScreenShotAsCheckpoint'('AdactinScreenShot2')

CustomKeywords.'applicationKeyword.WebKeywords.BookHotelAndVerifySelectedHotel'(findTestObject('Web_OR/Adactin/AdactinSpy/Page_Adactin.com - Search Hotel/Spy_inputdatepick_in'), 
    ...
    findTestObject('Web_OR/Adactin/AdactinSpy/Page_Adactin.com - Search Hotel/SpySubmit'), Location, HotelName, RoomType)
