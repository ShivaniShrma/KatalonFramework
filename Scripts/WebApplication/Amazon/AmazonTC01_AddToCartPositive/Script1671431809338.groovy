...
WebUI.click(findTestObject('Object Repository/Web_OR/Amazon/AmazonAddToCart (1)/Page_Online Shopping site/span_Hello, sign in'))
...
WebUI.click(findTestObject('Web_OR/Amazon/AmazonSpyAll/Page_Buy The Alchemist Book Online at Low Prices in India  The Alchemist Reviews  Ratings - Amazon.in/See All Buying OptionsForAddToCart'))

WebUI.click(findTestObject('Web_OR/Amazon/AmazonSpyAll/Page_Buy The Alchemist Book Online at Low Prices in India  The Alchemist Reviews  Ratings - Amazon.in/AddToCartBtn'))

WebUI.click(findTestObject('Web_OR/Amazon/AmazonSpyAll/Page_Buy The Alchemist Book Online at Low Prices in India  The Alchemist Reviews  Ratings - Amazon.in/Close-buttonAfterAddingToCart'))

WebUI.click(findTestObject('Object Repository/Web_OR/Amazon/AmazonAddToCart (1)/Page_Buy The Alchemist Book/a_1'))

WebUI.click(findTestObject('Web_OR/Amazon/AmazonSpyAll/Page_Amazon.in Shopping Cart/QuantityForCart'))

WebUI.click(findTestObject('Web_OR/Amazon/AmazonSpyAll/Page_Amazon.in Shopping Cart/Delete Quantity'))
